 ...
 * 从而产生波纹的效果.
 */
public class WifiRippleOutLayout extends RelativeLayout
{
    ...
    public WifiRippleOutLayout(Context context)
    {
        super(context);
        init(context, null);
    }

    public WifiRippleOutLayout(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init(context, attrs);
    }

    public WifiRippleOutLayout(Context context, AttributeSet attrs, int defStyleAttr)
    {
    ...
    private void initTypedArray(Context context, AttributeSet attrs)
    {
        TypedArray typedArray = context.obtainStyledAttributes(attrs,
            R.styleable.WifiRippleOutLayout);

        mRippleColor = typedArray.getColor(R.styleable.WifiRippleOutLayout_rippleout_color,
            DEFAULT_RIPPLE_COLOR);
        mStrokeWidth = typedArray.getDimension(
            R.styleable.WifiRippleOutLayout_rippleout_stroke_width, DEFAULT_STROKE_WIDTH);
        mRippleRadius = typedArray.getDimension(
            R.styleable.WifiRippleOutLayout_rippleout_radius, DEFAULT_RADIUS);
        mAnimDuration = typedArray.getInt(R.styleable.WifiRippleOutLayout_rippleout_duration,
            DEFAULT_DURATION_TIME);
        mRippleViewNums = typedArray.getInt(
            R.styleable.WifiRippleOutLayout_rippleout_rippleNums, DEFAULT_RIPPLE_COUNT);
        mRippleScale = typedArray.getFloat(R.styleable.WifiRippleOutLayout_rippleout_scale,
            DEFAULT_SCALE);
