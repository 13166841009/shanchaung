package ruanjianbei.wifi.com.Utils.CircleCurculate;
...
public class CircleChartView extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = getContext().obtainStyledAttributes(
                attrs, R.styleable.CircleChartView, defStyle, 0);

        pieChartCircleRadius = a.getDimension(
                R.styleable.CircleChartView_circleRadius,
                pieChartCircleRadius);

        mTextSize = a.getDimension(R.styleable.CircleChartView_textSize, mTextSize);

        if (a.hasValue(R.styleable.CircleChartView_exampleDrawable)) {
            mExampleDrawable = a.getDrawable(
                    R.styleable.CircleChartView_exampleDrawable);
