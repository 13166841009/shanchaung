...
import foregin.Defaults;
import foregin.FTPServerService;
import foregin.Globals;
...
public class WiFiActivity extends Activity {
	...
	public void updateUi() {
		...
		if (isWifiReady) {
			...
			startStopButtonText.setCompoundDrawablesWithIntrinsicBounds(running ? R.mipmap.disconnect
					: R.mipmap.connect, 0, 0, 0);
